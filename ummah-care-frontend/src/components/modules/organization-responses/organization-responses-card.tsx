...
import MangeRequestStatus from "../my-responses/mange-request-status";
import MyResponseDetails from "../my-responses/my-responses-details";
import ResponseForm from "../responses/response-form";

type OrganizationResponseCardProps = {
    ...
    <Card>
      <CardContent className="p-4 space-y-4">
        ...
        <div className="space-y-1">
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <TypographyMuted className="cursor-default text-xs">
                Expires: {formatExpiryDate(request.expiresAt)}
              </TypographyMuted>
            </TooltipTrigger>
            <TooltipContent>
        ...
        <div className="flex items-center gap-2">
          <TypographyMuted>Your Organization Role:</TypographyMuted>
      ...
      <CardFooter className="flex-wrap justify-between gap-3">
        <div className="flex items-center gap-3">
          <DataTableRowDeleteAction
            ...
            id={response.id}
            label={request.title}
            queryKey={QUERY_KEY.RESPONSE.ORGANIZATION_RESPONSES}
        ...
        <div className="flex gap-3">
          {request.helpType !== HELP_TYPE.PHYSICAL &&
            request.helpType !== HELP_TYPE.BOTH &&
